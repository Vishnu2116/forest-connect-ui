...
import { AboutElement, Organization, WhosWhoSection, VisionMission, LoanAgreement, OfficialDirectory } from "./pages/About";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/about/loan-agreement" element={<LoanAgreement />} />
