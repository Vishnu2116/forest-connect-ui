  ...
  return (
    <PageLayout>
      <PageHeader
        ...
        subtitle="Submit your grievance to the Department"
        ...
        <div className="gov-container grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 bg-card border border-border rounded-md p-6 shadow-card">
            ...
            >
              ...
              <Field label="Category" full>
                <select className="form-input">
                  <option>Forest Encroachment</option>
                  <option>Wildlife Issue</option>
                  <option>Plantation Concern</option>
              ...
              <Field label="Attachments (optional)" full>
                <input
                  type="file"
                  className="form-input file:mr-3 file:bg-primary file:text-primary-foreground file:border-0 file:px-3 file:py-1 file:rounded"
                />
              </Field>
              <div className="md:col-span-2 flex items-center gap-3 mt-2">
                ...
                <button
                  type="reset"
                  className="px-5 py-2.5 rounded font-semibold border border-border hover:bg-surface"
                >
                  Reset
                </button>
              </div>
          ...
          <aside className="space-y-4">
            {/* <div className="bg-primary text-primary-foreground rounded-md p-5">
              ...
              <p className="text-md opacity-90 mt-2">For urgent wildlife or forest emergencies, please call the toll-free helpline.</p>
            ...
            <div className="bg-card border border-border rounded-md p-5">
              ...
              <ol className="mt-3 text-md space-y-2 text-muted-foreground list-decimal list-inside">
