      ...
      <section className="py-10">
        <div className="gov-container max-w-4xl">
          <div className="bg-card border border-border rounded-md p-8 shadow-card space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>The information provided on this website is for general information purposes only. While the Tripura Forest Department endeavours to keep the information up-to-date and correct, no representations or warranties of any kind, express or implied, are made about the completeness, accuracy, reliability or suitability of the information.</p>
            ...
            <p className="font-semibold text-foreground">© 2026 Tripura Forest Department, Government of Tripura.</p>
          </div>
        </div>
      </section>
    </PageLayout>
