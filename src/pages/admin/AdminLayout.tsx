...
export const adminMenu = [
  ...
  { to: "/admin/knowledge-hub", label: "Knowledge Hub (All)", icon: BookOpen },
  { to: "/admin/knowledge-hub?type=publication", label: "— Publications", icon: BookOpen },
  { to: "/admin/knowledge-hub?type=report", label: "— Reports", icon: FileText },
  { to: "/admin/knowledge-hub?type=iec_material", label: "— IEC Materials", icon: ImageIcon },
  { to: "/admin/knowledge-hub?type=newsletter", label: "— Newsletters", icon: BookOpen },
  { to: "/admin/knowledge-hub?type=success_story", label: "— Success Stories", icon: Award },
  { to: "/admin/knowledge-hub?type=thematic_study", label: "— Thematic Studies", icon: FolderKanban },
  { to: "/admin/knowledge-hub?type=documentation", label: "— Documentation", icon: FileText },
  { to: "/admin/knowledge-hub?type=case_study", label: "— Case Studies", icon: FileText },
  { to: "/admin/knowledge-hub?type=notification", label: "— Notifications", icon: Bell },
  { to: "/admin/knowledge-hub?type=lessons_learned", label: "— Lessons Learned", icon: BookOpen },
